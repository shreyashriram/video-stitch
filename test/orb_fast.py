...
FRAME_SCALE = 1
OUTPUT_IMG = f"output/panorama_{video_name}_fast.jpg"
...
for i in tqdm(range(1, len(frame_files)), desc="🔧 Stitching"):
    ...
    # Update tracked corners for final cropping
...
# Now crop the canvas based on final bounds
final_img = crop_final_canvas(canvas, tracked_corners)
